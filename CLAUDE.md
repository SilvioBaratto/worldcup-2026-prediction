...
- `config/default.toml` — `[simulation]` (n_simulations=100000, extra_time_factor, seed), `[poisson]` (half-life, ρ, `elo_prior_weight`=0.8, `market_value_prior_weight`=0.7 squad-value prior), `[elo]`, `[hybrid]`/`[rf]` + `[odds]` (calibration), `[client]`/`[live]`/`[martj42]` (data sources).
